      ...
      },
    {
      ...
      },
      {
        ...
        highlights: [
          ...
          'Autofill rejects wrong master-key attempts',
      ...
      },
      {
        ...
        highlights: [
          ...
          'Vault travels as a single file',
          'No accounts, no sync',
        ],
        year: '2026',
      },
      ...
      },
      {
        ...
        featured: false,
        overview:
          'SpellWise proofreads text on pages you visit: a local EN/ES dictionary underlines likely misspellings with a blue pen, the popup offers one-click fixes, and your own words can be added to the personal dictionary.',
        highlights: [
      ...
      },
      {
        ...
        featured: false,
        overview:
          'StepScribe records your clicks and typed values on a page into a step-by-step instruction sheet with tiny element captures, then exports it as Markdown or HTML. All local, no accounts.',
        highlights: [
          'Records clicks and typed values with DOM selectors per step',
          'Mini element captures via drawImage thumbnails',
          'Exports Markdown or self-contained HTML with embedded captures',
      ...
      },
      {
        ...
        featured: false,
        overview:
          'ScreenLoom records your screen into clips (MV3): getDisplayMedia + MediaRecorder with a red REC indicator on every page, a stopwatch in the popup, and clip cards with thumbnails, length and format. Downloads .webm locally.',
        highlights: [
      ...
      },
      {
        ...
        featured: false,
        overview:
          'ReadStack stacks what you read: save the current page (title, URL and its readable text) into a personal stack in chrome.storage, with read/unread tracking, search, archive and JSON export. Page text is read only when you click the popup.',
        highlights: [
          'Saves title, URL and readable text to chrome.storage.local',
          'All/Unread/Archived filters with live search',
          '200-item cap with auto-pruning of oldest read items',
          'JSON export of the whole stack',
        ],
        year: '2026',
      },
      {
        ...
        featured: false,
        overview:
          'ClipNotes clips a note to anything: save the current page (title, URL, readable text) and add your own note, all stored privately in chrome.storage, with search and JSON/Markdown export.',
        highlights: [
      ...
      },
      {
        ...
        highlights: [
          ...
          'Persistent conversation history in extension storage',
          'No network calls, no API keys, no models in the cloud',
        ],
        year: '2026',
      },
      {
        ...
        featured: false,
        overview:
          'SessionSaver is a window session manager: save a snapshot of your open tabs and groups, search them, restore them later, and auto-save on a configurable interval. Everything stays in local extension storage.',
        highlights: [
          'Snapshots window tabs and tab groups',
          'Search across saved sessions by title or URL',
          'Auto-save on configurable interval',
          'Restore one window or all at once',
        ],
        year: '2026',
      },
      {
        ...
        featured: false,
        overview:
          'TabNest hives the window, keeping the pages: close every tab of a window into a named nest (with an estimated memory saving), then restore one nest or all of them whenever you want. Includes 6-language i18n.',
        highlights: [
          'Named nests with estimated memory savings',
          'Restore one nest or all nests anytime',
          '6-language i18n (EN, ES, FR, PT, IT, DE)',
          'Local storage only',
        ],
        year: '2026',
      },
      {
        ...
        featured: false,
        overview:
          'TabSnooze lets the window nap: background tabs are automatically discarded after a configurable idle time (Chrome frees their memory), with per-domain exceptions. Click a sleeping tab to wake it instantly.',
        highlights: [
      ...
      },
      {
        ...
        featured: false,
        overview:
          'LangBridge is a phrase-to-phrase translator: a small built-in EN-ES-FR dictionary (~200 terms) that translates words under your cursor, whole phrases in the popup, and known words on the page itself. Everything runs locally in chrome.storage.local.',
        highlights: [
      ...
      },
      {
        ...
        featured: false,
        overview:
          'HueLens is a local color inspector: pick a color from any element of a page on http://127.0.0.1 (computed-style approximation), convert HEX/RGB/HSL, keep a history, copy to clipboard and export your palette. Everything runs locally.',
        highlights: [
          'Computed-style color sampling from any page element',
          'HEX, RGB and HSL conversions computed locally',
          '50-color history with copy and palette export',
          '6-language i18n (EN, ES, FR, PT, IT, DE)',
        ],
        year: '2026',
      },
      {
        ...
        featured: false,
        overview:
          'SeoPulse is a local on-page SEO check for pages served from http://127.0.0.1: title, meta description, heading hierarchy, image alt texts, broken links, text/HTML ratio and keyword density, with a score and a traffic light.',
        highlights: [
          'Title, meta, heading hierarchy and image alt text checks',
          'Broken internal links (first 50) and text/HTML ratio',
          'Keyword density with traffic-light (green/yellow/red) scoring',
